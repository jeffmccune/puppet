...
module Puppet
  ...
  setdefaults(:master,
    ...
    :node_name_fact => ["hostname", "The Facter fact used to determine client
      identity If the node_name option is set to 'facter' this setting will be
      used to determine the facter value used to set the node name."],
    :bucketdir => {
